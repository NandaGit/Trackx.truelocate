...
public class GeneralActions {
	...
	public static Xlfile_Reader excel=new Xlfile_Reader(System.getProperty("user.dir")+fsep+"src"+fsep+"test"+fsep+"resources"+fsep+"Trackx.truelocate.xlsx");
	...
	public static WebDriver launchBrowser(WebDriver driver, String browserType){
		...
		if (browserType.equalsIgnoreCase(Constants.sBrowserFirefox)){
			...
			System.setProperty("webdriver.gecko.driver", (System.getProperty("user.dir")+fsep+"src"+fsep+"test"+fsep+"resources"+fsep+"geckodriver.exe"));
...
//						TestNGResults.put("1", new Object[] { "Test Step No.", "Action", "Expected Action", "Actual Output" });
						TestNGResults.put("1", new Object[] { "Action Executed", "Expected Action", "Actual Output" });
		}
		...
		public void suiteTearDown() {
			...
			try {
				FileOutputStream out = new FileOutputStream(new File("TestNGResult.xlsx"));
				workbook.write(out);
				out.close();
