...
public class Constants {
	...
	//Messages :  
	public String Title_msg="trueLOCATE";
	public String Error_ChargeType="Site already exists";
	public String Success_Type="Site created successfully";
	public String success_sitemsg ="Entity Location added successfully";
	public String error_addtype ="Code already in use, Please enter Unique Code";
